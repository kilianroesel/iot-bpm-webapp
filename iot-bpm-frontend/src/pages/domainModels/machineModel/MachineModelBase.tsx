    ...
    <div className="grid grid-cols-3 gap-4">
      <div className="space-y-4 rounded-md bg-slate-900 p-4">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-3xl font-medium grow">Scope</h3>
          {(machineModel.ruleStatus == "NOT_RELEASED" || machineModel.ruleStatus == "UPDATED") && (
            <IconButton onClick={() => createEventScopingRule.mutate()} className="inline-block h-full text-emerald-600 hover:text-emerald-500">
