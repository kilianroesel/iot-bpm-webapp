...
import EquipmentModelDelete from "../equipmentModel/EquipmentModelDelete";
import EquipmentModelCreate from "../equipmentModel/EquipmentModelCreate";

export default function EquipmentModelDetail() {
  const params = useParams();
  if (!params.machineModelId) throw new Error("nodsa dsa")
  const { data: equipmentModel } = useSuspenseQuery(equipmentModelQuery(params.machineModelId));
